...
var alien2,alien3,invi,invi2,tributetorem,bgsong,explosion,explosion1,invi,invi2,loading,loadingsc,gun,gunimg;
...
function draw() {
 ...
 // alien2.addAnimation("bluealien",a2);
      if (gameState==="play") {
        ...
        fill ("blue")
        stroke(1)
        text("Hi! Thanks for visiting me. No one bothers to come here to visit me. take this gun and shoot the evil alien!", 0, 500)
        }
